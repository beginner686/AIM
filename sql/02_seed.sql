...
VALUES
  ...
  ('ORDER_STATUS', 'WAIT_WORKER_ACCEPT', '待执行者接单', 'warning', 'ACTIVE', 40, 1, '{"groups":["ACTIVE"]}'),
  ('ORDER_STATUS', 'MATCH_UNLOCKED', '已解锁匹配', 'success', 'ACTIVE', 50, 1, '{"groups":["ACTIVE"]}'),
  ('ORDER_STATUS', 'IN_PROGRESS', '进行中', 'warning', 'ACTIVE', 60, 1, '{"groups":["ACTIVE"]}'),
  ('ORDER_STATUS', 'COMPLETED', '已完成', 'success', 'COMPLETED', 70, 1, '{"groups":["COMPLETED"]}'),
  ('ORDER_STATUS', 'DISPUTE', '争议中', 'danger', 'DISPUTE', 80, 1, '{"groups":["ACTIVE","DISPUTE"]}'),
  ('ORDER_STATUS', 'ARBITRATION', '仲裁中', 'danger', 'DISPUTE', 90, 1, '{"groups":["ACTIVE","DISPUTE"]}'),
  ('ORDER_STATUS', 'CLOSED', '已关闭', 'info', 'CLOSED', 100, 1, '{"groups":["CLOSED"]}'),
