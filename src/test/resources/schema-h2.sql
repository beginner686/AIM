...
CREATE TABLE user_account (
  ...
  review_score DECIMAL(3,2) NOT NULL DEFAULT 5.00,
...
CREATE TABLE worker_apply (
  ...
  apply_attachment_name VARCHAR(200),
  apply_attachment_url VARCHAR(500),
...
CREATE TABLE orders (
  ...
  service_fee_rmb BIGINT NOT NULL DEFAULT 0,
  service_fee_paid_time TIMESTAMP,
  labor_budget_amount DECIMAL(12,2) NOT NULL DEFAULT 0.00,
  labor_budget_currency VARCHAR(10) NOT NULL DEFAULT 'USD',
  employer_declared_paid TINYINT NOT NULL DEFAULT 0,
  employer_declared_paid_time TIMESTAMP,
  worker_confirmed_paid TINYINT NOT NULL DEFAULT 0,
  worker_confirmed_paid_time TIMESTAMP,
